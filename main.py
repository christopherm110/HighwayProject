...
from Sprites.hourglass import Hourglass
from Sprites.highscore import Highscore
from Sprites.menu import Menu
from Sprites.traffic import Traffic
...
while run:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP and event.button == 1:
            if not menu.title_screen and (not game_running or game_paused):
